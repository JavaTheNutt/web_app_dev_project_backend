...
describe('user model', () => {
  ...
  it('should create a user with one address', () => {
  ...
  it('should create a user with two addresses', () => {
  ...
  it('should fail when no email is passed', () => {
    userDetails.email = '';
    const user        = new User(userDetails);
  ...
  it('should fail when a poorly formed email is passed', () => {
